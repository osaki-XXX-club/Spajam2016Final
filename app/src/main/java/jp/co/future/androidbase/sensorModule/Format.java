package jp.co.future.androidbase.sensorModule;
...
public class Format {
	...
	public static final String BASE_GUI_FORMAT_MAG_XYZ = "Magnetic(X=%.0f, Y=%.0f, Z=%.0f)[uT]\n";
	public static final String BASE_GUI_FORMAT_ACC_XYZ = "Acceleration(X=%.2f, Y=%.2f, Z=%.2f)[G]\n";
	...
	public static final String BASE_CSV_FORMAT_MAG_XYZ = "%.0f,%.0f,%.0f,";
	public static final String BASE_CSV_FORMAT_EMPTY_XYZ = ",,,";
	public static final String BASE_CSV_FORMAT_ACC_XYZ = "%.2f,%.2f,%.2f,";
	public static final String BASE_CSV_FORMAT_UV = "%.1f,";
	public static final String BASE_CSV_FORMAT_EMPTY = ",";
	public static final String BASE_CSV_FORMAT_AMBIENT_LIGHT = "%.1f,";
	public static final String BASE_CSV_FORMAT_HUMIDITY = "%.1f,";
	public static final String BASE_CSV_FORMAT_TEMPERATURE = "%.1f,";
	public static final String BASE_CSV_FORMAT_PRESSURE = "%.1f";

	public static String GUI_FORMAT_MAG_XYZ = "Magnetic(X=%.0f, Y=%.0f, Z=%.0f)[uT]\n";
	public static String GUI_FORMAT_ACC_XYZ = "Acceleration(X=%.2f, Y=%.2f, Z=%.2f)[G]\n";
	...
	public static String CSV_FORMAT_MAG_XYZ = "%.0f,%.0f,%.0f,";
	public static String CSV_FORMAT_EMPTY_XYZ = ",,,";
	public static String CSV_FORMAT_ACC_XYZ = "%.2f,%.2f,%.2f,";
	public static String CSV_FORMAT_UV = "%.1f,";
	public static String CSV_FORMAT_EMPTY = ",";
	public static String CSV_FORMAT_AMBIENT_LIGHT = "%.1f,";
	public static String CSV_FORMAT_HUMIDITY = "%.1f,";
	public static String CSV_FORMAT_TEMPERATURE = "%.1f,";
	public static String CSV_FORMAT_PRESSURE = "%.1f";
