...
import jp.co.future.androidbase.sensorModule.command.notify.NotifyBLEConnectionParametersAdjustment;
import jp.co.future.androidbase.sensorModule.command.notify.NotifySequencerError;
import jp.co.future.androidbase.sensorModule.command.sensorData.SensorDataPacket;
import jp.co.future.androidbase.sensorModule.command.sensorData.SensorDataPacketMagAcc;
import jp.co.future.androidbase.sensorModule.command.sensorData.SensorDataPacketPreHumTemUVAmLight;
import jp.co.future.androidbase.sensorModule.enums.AccelerationSensorRange;
		...
		public void onReceiveNotification(BLEConnect.NotifierType type, byte[] bytes) {
			...
			switch (type) {
				case SensorDataAndStatus: {
					...
					Log.d(TAG,"INDEX_EVENT_CODE="+bytes[SensorDataPacket.INDEX_EVENT_CODE]);

					switch (bytes[SensorDataPacket.INDEX_EVENT_CODE]) {
						case SensorDataPacketMagAcc.EVENT_CODE: {
							Log.d(TAG,"SensorDataPacketMagAcc");
							...
							Log.d(TAG,"accX:"+latestData.accX);
						...
						case SensorDataPacketPreHumTemUVAmLight.EVENT_CODE: {
							Log.d(TAG,"SensorDataPacketPreHumTemUVAmLight");
						...
						case CtrlCmdRequestStatus.EVENT_CODE_RESULT: {
							Log.d(TAG,"CtrlCmdRequestStatus");
